                ...
                <div class="col-lg-12">
                    <div class="cart-table">
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    <td class="cart-pic first-row"><img src="/assets/front/img/cart-page/product-1.jpg" alt=""></td>
                                ...
                                <tr>
                                    <td class="cart-pic"><img src="/assets/front/img/cart-page/product-2.jpg" alt=""></td>
                                    <td class="cart-title">
                                ...
                                <tr>
                                    <td class="cart-pic"><img src="/assets/front/img/cart-page/product-3.jpg" alt=""></td>
                                    <td class="cart-title">
